  ...
  return !loading ? (
    <section className="main container section" >
        <div className='top-slideshow-div'>
            ...
            <Carousel autoplay>
            <div>
                            <img className="mySlides" alt='wall' src="https://th.bing.com/th/id/R.17165b6e9cad01442913960b0ed18343?rik=wouQPnVfb8LrWA&riu=http%3a%2f%2fwww.japjitravel.com%2fblog%2fwp-content%2fuploads%2f2017%2f04%2fTaj-Mahal.jpg&ehk=isNV1lcW5FH7SxoGKQGfnSg03874LdT%2fIga%2fiCV%2bBtY%3d&risl=&pid=ImgRaw&r=0" style={contentStyle} />
                            </div>
            <div>
                <img className="mySlides" alt='wall' src="https://loveincorporated.blob.core.windows.net/contentimages/gallery/818d8b01-8844-4ac2-8ecb-72a40fa7ec0b-Temple-Amritsar-Elena-Odareeva.jpg" style={contentStyle} />
            </div>
            <div>
                <img className="mySlides" alt='wall' src="https://www.nortonrosefulbright.com/-/media/images/nrf/nrfweb/knowledge/publications/global-fdi/india.jpeg?la=en-hk&revision=&hash=CAF3A0694161AA8979D726C8BBB908E3AD5F6A1C" style={contentStyle} />
            </div>
            <div>
                <img className="mySlides" alt='wall' src="https://tripnxt.com/blog/wp-content/uploads/2020/02/TripNxt-Varanasi-1536x1021.jpg" style={contentStyle} />
            </div>
            <div>
                <img className="mySlides" alt='wall' src="https://wallpapercave.com/wp/AtzSnEY.jpg" style={contentStyle} />
            </div>
            <div>
                <img className="mySlides" alt='wall' src="https://wallpaperbat.com/img/332681-wallpaper-river-home-india-image-for-desktop-section-gorod.jpg" style={contentStyle} />
            </div>
            <div>
            ...
            <div>
                <img className="mySlides" alt='wall' src="https://images.yourstory.com/cs/wordpress/2016/03/yourstory-delhigovt-incubation.jpg?w=1152&fm=auto&ar=2:1&mode=crop&crop=faces" style={contentStyle} />
            </div>
            </Carousel>
        ...
        <div className="secContent grid">
            {PopularSpotDetails?.length > 0  ? (<>{
                ...
                ):( <div class="EventCard" style={{display:'flex',alignItems:'center',justifyContent:'center'}}>No TouristSpots</div>)}
        ...
        <div className="secContent grid">
            ...
            }<p>More places to be added soon</p></>):( <div class="EventCard" style={{display:'flex',alignItems:'center',justifyContent:'center'}}>No TouristSpots</div>)}
