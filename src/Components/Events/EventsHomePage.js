  ...
  return !loading ? (
    <section className="main container section">
        ...
        <div className='top-slideshow-div' >
                    <Carousel autoplay>
                      <div>
                        <img className="mySlides" alt='wall' src="https://wallpaperaccess.com/full/6133725.jpg" style={contentStyle} />
                      </div>
                      <div>
                        <img className="mySlides" alt='wall' src="https://liveeventproductions.co.uk/wp-content/uploads/2018/01/event-production-services-live-event-productions-banner-image-4.jpg" style={contentStyle} />
                      </div>
                      <div>
                        <img className="mySlides" alt='wall' src="https://wallpaperaccess.com/full/2489735.jpg" style={contentStyle} />
                      </div>
                      <div>
                      ...
                      <div>
                        <img className="mySlides" alt='wall' src="https://wallpapercave.com/wp/wp7488400.jpg" style={contentStyle} />
                      </div>
                      <div>
                        <img className="mySlides" alt='wall' src="https://s3-media1.fl.yelpcdn.com/bphoto/oPVG4wXUdpyYXfJ4jg5-Mw/o.jpg" style={contentStyle} />
                      </div>
                      <div>
                        <img className="mySlides" alt='wall' src="https://www.jettext.net/wp-content/uploads/2021/11/Creamfields-10-Worlds-Wildest-Parties-Jet-Text-Blog.jpg" style={contentStyle} />
                      </div>
                    </Carousel>
            </div>
